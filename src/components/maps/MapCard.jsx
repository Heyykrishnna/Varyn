...
export default function MapCard({ map, onOpen }) {
  const { name, biome, tagline, size, previewGradient, previewImage } = map;
    ...
    >
      ...
      <div className="p-5">
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="text-[10px] uppercase px-2 py-1 rounded bg-white/10 border border-white/15 text-white/80">{size}</span>
        </div>
